...
export const site = {
  ...
  description:
    '다양한 디자인과 인터렉션을 적용한 웹 페이지를 제작하고 있습니다. 브랜드 웹사이트, 쇼핑몰, 랜딩 페이지 제작.',
  ...
  hero: {
    badge: 'NEW',
    badgeText: '2026 포트폴리오 업데이트',
    /** 줄바꿈 지점을 배열로 나눠 둔다. */
    headline: ['웹 경험을', '설계합니다.'],
    lead: '다양한 디자인과 인터렉션을 적용한 웹 페이지를 제작하고 있습니다.',
  },

  about:
    'FF Hub는 브랜드의 이야기를 웹 화면 위의 장면으로 옮기는 스튜디오입니다. 랜딩 페이지, 브랜드 웹 사이트, 스토어 디자인 등 다양한 분위기와 컨셉에 맞는 시도를 하고 있습니다.',

  servicesLead: '기획에서 운영까지, 웹 한 편을 만드는 데 필요한 일을 합니다.',
